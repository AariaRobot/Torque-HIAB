...
model = 'AariaHIABR2017a';
simIn(1) = Simulink.SimulationInput(model);
%open('AariaJoystickR2017a.slx')
set_param('AariaHIABR2017a','SimulationMode','normal')
set_param('AariaHIABR2017a','SimMechanicsOpenEditorOnUpdate','on')
set_param('AariaHIABR2017a','StopTime','inf')
